...
import { LegalLayout, LegalList } from "@/modules/legal/components";
import { LegalArticle, LegalNote, LegalPageHeader, LegalSection } from "@/modules/legal/components";
      ...
      <LegalLayout toc={sections} tocLabel={t("common.toc_label_privacy")} onThisPageLabel={t("common.on_this_page")}>
        ...
        <Reveal>
          <LegalSection id="scope" number={sectionById.get("scope")!.number} title={sectionById.get("scope")!.label}>
            <p className="text-foreground/80 text-xs">{t("privacy.content.scope.intro")}</p>
            <p className="text-foreground/80 mt-2 text-xs">{t("privacy.content.scope.footer")}</p>
          </LegalSection>
        </Reveal>
        <Reveal>
          <LegalSection
          ...
          >
            <p className="text-foreground/80 text-xs">{t("privacy.content.data-we-collect.intro")}</p>
        ...
        <Reveal>
          ...
          >
            <p className="text-foreground/80 text-xs">{t("privacy.content.how-we-use.intro")}</p>
            ...
            <LegalArticle title={t("privacy.content.how-we-use.legal_basis.title")}>
              <p className="text-foreground/80 text-xs">{t("privacy.content.how-we-use.legal_basis.body")}</p>
            </LegalArticle>
          </LegalSection>
        </Reveal>
        <Reveal>
          ...
          >
            <p className="text-foreground/80 text-xs">{t("privacy.content.subscribers.intro")}</p>
            <LegalArticle title={t("privacy.content.subscribers.controller.title")}>
              <p className="text-foreground/80 text-xs">{t("privacy.content.subscribers.controller.body")}</p>
            ...
            <LegalArticle title={t("privacy.content.subscribers.obligations.title")}>
              <p className="text-foreground/80 text-xs">{t("privacy.content.subscribers.obligations.body")}</p>
        ...
        <Reveal>
          ...
          >
            <p className="text-foreground/80 text-xs">{t("privacy.content.ai-and-automation.intro")}</p>
        ...
        <Reveal>
          <LegalSection id="sharing" number={sectionById.get("sharing")!.number} title={sectionById.get("sharing")!.label}>
            <p className="text-foreground/80 text-xs">{t("privacy.content.sharing.intro")}</p>
        ...
        <Reveal>
          ...
          >
            <p className="text-foreground/80 text-xs">{t("privacy.content.subprocessors.intro")}</p>
            <LegalList items={t.raw("privacy.content.subprocessors.items") as string[]} variant="disc" />
            <p className="text-foreground/80 mt-2 text-xs">{t("privacy.content.subprocessors.footer")}</p>
          </LegalSection>
        </Reveal>
        <Reveal>
          <LegalSection
          ...
          >
            <p className="text-foreground/80 text-xs">{t("privacy.content.international.intro")}</p>
            <p className="text-foreground/80 mt-2 text-xs">{t("privacy.content.international.footer")}</p>
          </LegalSection>
        </Reveal>
        <Reveal>
          <LegalSection
          ...
          >
            <p className="text-foreground/80 text-xs">{t("privacy.content.retention.intro")}</p>
        ...
        <Reveal>
          ...
          >
            <p className="text-foreground/80 text-xs">{t("privacy.content.security.intro")}</p>
        ...
        <Reveal>
          ...
          >
            <p className="text-foreground/80 text-xs">{t("privacy.content.your-rights.intro")}</p>
        ...
        <Reveal>
          ...
          >
            <p className="text-foreground/80 text-xs">{t("privacy.content.children.intro")}</p>
          </LegalSection>
        </Reveal>
        <Reveal>
          <LegalSection id="changes" number={sectionById.get("changes")!.number} title={sectionById.get("changes")!.label}>
            <p className="text-foreground/80 text-xs">{t("privacy.content.changes.intro")}</p>
            <p className="text-foreground/80 mt-2 text-xs">{t("privacy.content.changes.footer")}</p>
          </LegalSection>
        </Reveal>
        <Reveal>
          <LegalSection id="contact" number={sectionById.get("contact")!.number} title={sectionById.get("contact")!.label}>
            <p className="text-foreground/80 text-xs">{t("privacy.content.contact.intro")}</p>
